"""
Django settings for btshare project.
...
SECRET_KEY = 'upw1apz#bkml42)@^76l3)0w2@co$7)4+)ei8(=ks$s3kyx=0c'
...
ROOT_URLCONF = 'btshare.urls'

WSGI_APPLICATION = 'btshare.wsgi.application'
